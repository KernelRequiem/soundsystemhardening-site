...
## Ce que ce wiki veut être dans 12 mois
...
## Objectifs concrets à 12 mois

### Contenu

**Ce qui manque le plus :** pages opérationnelles sur les situations concrètes.

| Priorité | Page manquante | Compétence requise |
|----------|---------------|-------------------|
| Critique | Procédure complète après une saisie de matériel | Juridique + terrain |
...
**Objectif : 20 pages nouvelles d'ici juin 2027.**
...
On ne cherche pas des gens parfaits. On cherche des gens compétents sur un sujet précis, qui peuvent écrire ou relire une page, et qui comprennent pourquoi ce wiki doit exister.

### Juristes et avocats

**Pourquoi :** les pages juridiques sont les plus critiques et les plus difficiles à écrire sans formation. Une erreur sur les droits en GAV peut avoir des conséquences concrètes pour quelqu'un qui s'appuie dessus.

**Ce qu'on demande :** relire et corriger les pages existantes, rédiger des analyses de jurisprudence, valider les procédures décrites.

**Engagement minimum :** 2 à 3 heures par mois.
...
**Engagement minimum :** quelques heures ponctuelles par sujet.

### Personnes du terrain

**Pourquoi :** ce que la jurisprudence et les textes de loi ne disent pas, c'est ce que ça donne concrètement. Les retours d'expérience de personnes qui ont vécu une saisie, une GAV, une intervention sont la matière première des pages les plus utiles.

**Ce qu'on demande :** témoignages anonymisés, relecture des pages pratiques, signalements sur la carte.

**Engagement minimum :** une contribution ponctuelle suffit.
...
**Engagement minimum :** une page complète suffit pour commencer.

---

## Ce que n'est pas ce wiki

**Pas une organisation déclarée.** Pas de hiérarchie, pas de cotisation, pas de permanence. Les contributeurs s'impliquent à leur rythme, sur les sujets qui les intéressent.

**Pas un outil de mobilisation politique.** Ce wiki documente et outille. Il ne prend pas position sur des partis, des candidats, des élections. La résistance à la répression des free parties est un sujet de droits civils, pas de programme politique.

**Pas une base de données personnelles.** Aucune donnée permettant d'identifier des contributeurs ou des participants n'est publiée. L'anonymat des contributeurs est respecté.
...
*La prochaine mise à jour de cette page est prévue en septembre 2026.*
